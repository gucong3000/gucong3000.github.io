...
$.extend({
	...
	//æ“ä½œæ»¤é•œçš„æ–¹æ³•ï¼Œè¿”å›žç»™å®šæ»¤é•œå¯¹è±¡ã€‚
	msFilter: function( elem, name, args ) {
		//å¦‚æžœæ”¯æŒæ»¤é•œæ‰è¿è¡Œ
		if ( elem.filters ) {
			//å¦‚æžœæ»¤é•œåæœªä½¿ç”¨å‘½åç©ºé—´ï¼Œè‡ªåŠ¨ä½¿ç”¨å¾®è½¯çš„
...
//ÈÃIEÖ§³ÖCSSµÄdisplay¿ÉÒÔÎªinline-block
$.cssHooks.display = {
	set: function( elem, value ) {
...
//ÈÃIE6Ö§³ÖCSSµÄposition¿ÉÒÔÎªfixed
$.cssHooks.position = {
	get: function( elem ) {
...
//IE6µÄwidthºÍmin-widthÍêÈ«¾ÍÊÇÒ»»ØÊÂ¡£heightÍ¬Àí 
