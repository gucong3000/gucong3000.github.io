...
$( function() {
	with ( document.body ) {
		if( document.documentMode < 6 && currentStyle.backgroundColor == "#ffffff" ) {
	...
	for ( var i = 0; i < document.frames.length; i++ ) {
		...
		if ( !frame.getAttribute("sframeBorder") ) {
			frame.frameBorder = 0;
